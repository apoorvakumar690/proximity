...
func NewUser(conf config.IConfig, user repo.UserRepoInterface, rating rating.Rater, favourite favourite.FavouriteInterface) UsersInterface {
	return &Users{config: conf, user: user, rating: rating, favourite: favourite}
}
